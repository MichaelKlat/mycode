...
print("The first item in the list (IP): " + my_list[0] ) # Print the 1st element
print("The second item in the list (port): " + str(my_list[1]) ) # Print the 2nd element
print("The last item in the list (state): " + my_list[2] ) # Print the 3rd element
